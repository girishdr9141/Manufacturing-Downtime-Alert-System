...
const translations = {
  en: {
    ...
    aiWarning: 'AI PREDICTION',
    aiWarningDesc: 'Probability of critical failure within 24h exceeds 75%. Preventive maintenance recommended immediately.',
    fullName: 'Full Name',
    email: 'Email',
    password: 'Password',
  ...
  ja: {
    ...
    loginTitle: '製造DX',
    loginSubtitle: 'セキュアなリモートオペレーションポータル',
    aiPredictiveEngine: 'AI 予測エンジン',
    failureProbability: '故障確率',
    aiWarning: 'AI 予測警告',
    aiWarningDesc: '24時間以内の致命的な故障確率が75%を超えています。直ちに予防保守を実施することを推奨します。',
    fullName: '氏名',
    email: 'メールアドレス',
    password: 'パスワード',
    loginBtn: '安全なログイン',
